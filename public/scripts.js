...
const menuAdminItems = document.querySelectorAll(".menu a")
const menuSiteItems = document.querySelectorAll(".menu a")

for (item of menuAdminItems) {
    if (currentPageActive.includes(item.getAttribute("href"))) {
        item.classList.add("active")
    }
}

for (item of menuSiteItems) {
    if (currentPageActive.includes(item.getAttribute("href"))) {
        item.classList.add("active")
    }
}
